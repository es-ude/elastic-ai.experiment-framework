...
from elasticai.experiment_framework.remote_control.remote_control_protocol import (
    RemoteControlProtocol,
)
from elasticai.experiment_framework.remote_control.remote_task_controller import (
...
async def on_last_chunk(ctx):
    print("The last chunk is recived")
