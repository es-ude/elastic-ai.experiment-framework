...
int main(int argc, char *argv[])
{
    ...
    task_ctx = (TaskContext){.outgoing_rb = &outgoing_rb};

    init_task_manager(&outgoing_rb, &task_manager, task_ctx); // Initialize task manager with outgoing ring buffer for sending responses
